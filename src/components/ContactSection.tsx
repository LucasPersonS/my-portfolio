    ...
    <section className="relative py-20 bg-white text-center overflow-hidden rounded-top shadow-md-dark">
      <div className="flex flex-col items-center">
        ...
        <div className="flex space-x-4">
          <button className="flex items-center px-6 py-3 bg-black text-white font-bold rounded-full hover:bg-gray-800 transition">
            <FaEnvelope className="mr-2" /> Get in Touch
          </button>
          <button className="flex items-center px-6 py-3 bg-white text-black font-bold border border-black rounded-full hover:bg-gray-200 transition">
